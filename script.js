...
// ============================
const scriptURL = "https://script.google.com/macros/s/AKfycbzvaW8gullfpcFxEsjSJXJAL5wS2fZP26DLdXf5--jnrbji_k8pqGsge50Dnlo7rYc0/exec"; // Ganti dengan URL Web App dari Apps Script
...
function generate() {
  ...
  .then(resData => {
    if(resData.status !== "success"){
      console.error("Gagal mengirim data ke spreadsheet:", resData.message);
    }
  })
  .catch(err => console.error("Error fetch:", err));

  // ============================
  // TAMPILKAN DATA KE KUITANSI
  // ============================
